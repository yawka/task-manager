...
export default {
  ...
  methods: {
    ...
    fetchUserGroups() {
      axios.get('http://localhost:8816/users/groups', {
        params: {
          size: 1000,
        },
      })
...
.list-group-item {
  ...
  align-items: center;
  margin-bottom: 15px;
  padding-bottom: 0; /* Add padding to create space for the line */
  border-bottom: 1px solid #ccc; /* Add a bottom border between userGroups */
}

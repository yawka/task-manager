<template>
  ...
  export default {
    ...
    methods: {
      ...
      loadGroupData() {
        UserGroupDataService.get(this.userGroupId)
          .then((response) => {
      ...
      update() {
        ...
        console.log("Updating group:", this.title);
        var data = {
          groupName: this.title,
        };
        UserGroupDataService.update(this.userGroupId, data)
          .then((response) => {
            console.log(response.data);
            this.showSnackbarSuccess("Group successfully updated.");
            this.closeDialog();
          })
          .catch((e) => {
            console.log(e);

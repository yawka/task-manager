...
@Component
public class TaskStartedObserver implements Observer {
    private final Publisher publisher;
    private final NotificationConfig notificationConfig;
    private final NotificationSender notificationSender;
    public TaskStartedObserver(Publisher publisher, NotificationConfig notificationConfig, NotificationSender notificationSender) {
